...
export const SkeletonOne = () => {
  ...
  >) => {
    return (
      <motion.div
        {...props}
        className={cn(
          "w-24 h-24 md:w-56 md:h-56 p-6 rounded-lg relative shadow-lg flex items-center bg-gradient-to-b from-white to-white dark:from-neutral-800 dark:to-neutral-700 justify-center",
          props.className
        )}
      >
        {children}
  ...
  return (
    <div className="relative flex items-center justify-center  w-full h-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto w-full relative z-30 [perspective:1000px] [transform-style:preserve-3d] p-8 sm:p-0">
        <Container
          initial={{ y: 0 }}
        ...
        >
          <img 
            ...
            alt="Kaspersky" 
            className="h-48 w-48 object-contain mt-[-60px]"
          />
        </Container>
        <Container
          initial={{ y: 0 }}
...
const GitHubLogo = () => {
  return (
    <svg
      ...
      version="1.1"
      xmlns="http://www.w3.org/2000/svg"
      className="h-16 w-16 object-contain text-black dark:text-white"
    >
      <g
        id="Page-1"
        stroke="none"
